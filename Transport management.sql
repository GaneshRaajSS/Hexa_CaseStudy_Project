...
ADD CONSTRAINT check_VStatus CHECK(Status IN('Available', 'OnTrip', 'Maintenance','Booked'))
...
INSERT INTO Routes VALUES ('Chennai', 'Kodaikanal', 540.00),
('Coimbatore', 'Tiruchirappalli', 210.00),
('Madurai', 'Erode', 260.00),
('Chennai', 'Kanyakumari', 705.8)
...
CREATE TABLE Driver(
DriverId INT PRIMARY KEY IDENTITY(500,1),
...
ALTER TABLE Driver
ADD CONSTRAINT check_Dtatus CHECK(Status IN('Available', 'Allocated'))

ALTER TABLE Driver
ADD CONSTRAINT DF_Driver_Status DEFAULT 'Available' FOR Status;

ALTER TABLE Trips 
ADD DriverId INT

ALTER TABLE Trips 
ADD CONSTRAINT FK_Driver_Id FOREIGN KEY (DriverId)
...
INSERT INTO Driver (DriverName, DriverLicense, DriverRatings) VALUES ('John', 'E9WCP372I9', 4.3),
('Jacob', 'CP02137UT2', 4.0),
('Manoj', 'U41ODIVS0Z', 3.0),
('Kalai', 'HRJU2C9XY4', 2.7),
('Astuf', 'DJ1BOEHT09', 3.9);
